  ...
  return (
    <form onSubmit={handleFormSubmit} className="flex flex-wrap w-full">
      ...
      <input
        ...
        className="w-3/4 border-2 border-r-0 border-gray-500 h-12 rounded-l-lg px-4 focus:outline-none focus:border-blue-600 disabled:bg-gray-500 text-black transition-colors duration-150"
        placeholder="Search for programID "
        disabled={loading}
        required
      />
      <button
